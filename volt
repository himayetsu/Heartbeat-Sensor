...
#define THRESHOLD_VOLTAGE 2.0f // 2.0V threshold for LD2 activation
...
static void MX_ADC1_Init(void) {
    ...
    sConfig.Channel = ADC_CHANNEL_0; // Using PA0 as the ADC channel
    sConfig.Rank = 1;
...
void Error_Handler(void) {
    while (1) {
        HAL_GPIO_TogglePin(GPIOA, GPIO_PIN_5); // Blink LD2 to indicate error
